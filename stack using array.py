#AIM:IMPLEMENT A MENU DRIVEN PROGRAM FOR THE FOLLOWING OPERATIONS ON STACK USING ARRAYS
...
class Stack:
    ...
    def palindrome(self):
        ...
        for i in range(0,stack2.top+1):
            if(stack2.stack[i]!=stack2.pop()):
                x=1
                break
        if(x==0): print("Stack is plaindrome\n")
        else: print("Stack is not a palindrome\n")
    ...
    def start(self):
        while(True):
            print("1.Push an Element on to Stack\n"+
